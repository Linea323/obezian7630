...
function moveToCenter()
    local direction
    if Me.x > 0 then direction = "West"
    elseif Me.x < 0 then direction = "East"
    elseif Me.y > 0 then direction = "South"
    else direction = "North"
    end
    print(colors.blue .. "Moving towards the center in direction: " .. direction .. colors.reset)
